...
(assert (= $generated@@259 ($generated@@231 10)))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let (($generated@@579 true))
(let (($generated@@580 true))
(let (($generated@@581  (=> (= $generated@@575 ($generated@@156 $generated@@576 $generated@@577 $generated@@60 false)) (and (=> (= (ControlFlow 0 3) (- 0 4)) (= $generated@@259 ($generated@@231 10))) (=> (= $generated@@259 ($generated@@231 10)) (and (=> (= (ControlFlow 0 3) 1) $generated@@580) (=> (= (ControlFlow 0 3) 2) $generated@@579)))))))
(let (($generated@@582  (=> (and (and ($generated@@237 $generated@@577) ($generated@@578 $generated@@577)) (and (= 1 $generated@@258) (= (ControlFlow 0 5) 3))) $generated@@581)))
$generated@@582)))))
))
(check-sat)
(pop 1)
