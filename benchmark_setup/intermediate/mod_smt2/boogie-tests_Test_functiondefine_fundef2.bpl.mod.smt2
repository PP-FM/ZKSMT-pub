...
(define-fun foo2 ((x Int) (y Int) ) Int (+ x y))
(define-fun foo ((x@@0 Int) ) Bool (> (foo2 x@@0 x@@0) 0))
(push 1)
...
(let ((anon3_Then_correct  (=> (and (and (foo x@@1) (= r@0 (foo2 x@@1 x@@1))) (and (= r@1 r@0) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))
...
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 2) (- 0 1)) (> r@1 0))))
(let ((anon3_Else_correct  (=> (not (foo x@@1)) (=> (and (= r@1 1) (= (ControlFlow 0 4) 2)) GeneratedUnifiedExit_correct))))
(let ((anon3_Then_correct  (=> (and (and (foo x@@1) (= r@0 (foo2 x@@1 (- 0 x@@1)))) (and (= r@1 r@0) (= (ControlFlow 0 3) 2))) GeneratedUnifiedExit_correct)))
(let ((anon0_correct  (and (=> (= (ControlFlow 0 5) 3) anon3_Then_correct) (=> (= (ControlFlow 0 5) 4) anon3_Else_correct))))
anon0_correct)))))
))
(check-sat)
