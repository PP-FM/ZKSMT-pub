...
(let ((anon7_Then_correct  (and (=> (= (ControlFlow 0 5) (- 0 6)) (= 5 5)) (=> (= 5 5) (=> (= (ControlFlow 0 5) 2) anon5_correct)))))
(let ((anon6_Then_correct  (and (=> (= (ControlFlow 0 3) (- 0 4)) (= 1 1)) (=> (= (ControlFlow 0 3) 2) anon5_correct))))
