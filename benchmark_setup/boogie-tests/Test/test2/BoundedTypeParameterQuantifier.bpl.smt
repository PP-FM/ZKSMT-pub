...
(assert  (and (and (and (and (and (and (and (and (and (and (and (forall ((arg0@@11 T@T) (arg1 T@T) ) (! (= (Ctor (MapType0Type arg0@@11 arg1)) 6)
...
(= (type (MapType0Store arg0@@15 arg1@@3 arg2)) (MapType0Type aVar0 aVar1@@0))))
 ...
 :weight 0
)))) (forall ((arg0@@16 T@T) (arg1@@4 T@T) ) (! (= (Ctor (MapType arg0@@16 arg1@@4)) 7)
 :qid |ctor:MapType|
))) (forall ((arg0@@17 T@T) (arg1@@5 T@T) ) (! (= (MapTypeInv0 (MapType arg0@@17 arg1@@5)) arg0@@17)
 :qid |typeInv:MapTypeInv0|
 :pattern ( (MapType arg0@@17 arg1@@5))
))) (forall ((arg0@@18 T@T) (arg1@@6 T@T) ) (! (= (MapTypeInv1 (MapType arg0@@18 arg1@@6)) arg1@@6)
 :qid |typeInv:MapTypeInv1|
 :pattern ( (MapType arg0@@18 arg1@@6))
))) (forall ((arg0@@19 T@U) ) (! (let ((QUN (MapTypeInv0 (type arg0@@19))))
(= (type (|Map#Domain| arg0@@19)) (MapType0Type QUN boolType)))
 :qid |funType:Map#Domain|
 :pattern ( (|Map#Domain| arg0@@19))
))) (forall ((QUN@@0 T@T) (YAN T@T) ) (! (= (type (|Map#Empty| QUN@@0 YAN)) (MapType QUN@@0 YAN))
 :qid |funType:Map#Empty|
 :pattern ( (|Map#Empty| QUN@@0 YAN))
))))
(assert (forall ((u T@U) (YAN@@0 T@T) ) (! (let ((QUN@@1 (type u)))
 (not (U_2_bool (MapType0Select (|Map#Domain| (|Map#Empty| QUN@@1 YAN@@0)) u))))
 :qid |BoundedTypeParameterQuantifierbpl.8:25|
 :skolemid |0|
 :pattern ( (let ((QUN@@1 (type u)))
(MapType0Select (|Map#Domain| (|Map#Empty| QUN@@1 YAN@@0)) u)))
)))
(push 1)
