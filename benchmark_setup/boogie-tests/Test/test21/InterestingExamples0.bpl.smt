...
(= (type (MapType0Store arg0@@14 arg1@@0 arg2)) (MapType0Type aVar0@@0)))
 ...
 :weight 0
)))) (= (type a@0) (MapType0Type intType))) (= (type a) (MapType0Type intType))) (= (type a@1) (MapType0Type intType))))
(set-info :boogie-vc-id P)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (= a@0 (MapType0Store a (int_2_U 5) (int_2_U 0))) (=> (and (= a@1 (MapType0Store a@0 (bool_2_U true) (int_2_U 1))) (= (ControlFlow 0 2) (- 0 1))) (= (U_2_int (MapType0Select a@1 (int_2_U 5))) 0)))))
