...
(assert (forall ((x@@8 T@U) ) (!  (=> (= (type x@@8) intType) (f x@@8))
 :qid |Triggers1bpl.11:15|
 :skolemid |0|
 :no-pattern (type x@@8)
 :no-pattern (U_2_int x@@8)
 :no-pattern (U_2_bool x@@8)
)))
(assert (forall ((x@@9 Int) ) (! (g x@@9)
 :qid |Triggers1bpl.12:15|
 :skolemid |1|
)))
(push 1)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 7) (let ((anon0_correct  (and (=> (= (ControlFlow 0 2) (- 0 6)) (f (int_2_U x@@10))) (=> (f (int_2_U x@@10)) (and (=> (= (ControlFlow 0 2) (- 0 5)) (f (MapType0Select m (int_2_U x@@10)))) (=> (f (MapType0Select m (int_2_U x@@10))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (g x@@10)) (=> (g x@@10) (and (=> (= (ControlFlow 0 2) (- 0 3)) (g (U_2_int (MapType0Select m (int_2_U x@@10))))) (=> (g (U_2_int (MapType0Select m (int_2_U x@@10)))) (=> (= (ControlFlow 0 2) (- 0 1)) (f (bool_2_U true)))))))))))))
