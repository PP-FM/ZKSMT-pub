...
(= (type (MapType0Store arg0@@15 arg1@@3 arg2)) (MapType0Type aVar0 aVar1@@0))))
 ...
 :weight 0
)))) (= (type h) (MapType0Type intType boolType))))
(set-info :boogie-vc-id Q)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 4) (let ((anon0_correct  (=> (forall ((m@@2 T@U) (x@@8 T@U) ) (! (let ((t (type x@@8)))
 (=> (= (type m@@2) (MapType0Type t boolType)) (= (U_2_bool (MapType0Select m@@2 x@@8)) false)))
 :qid |InterestingExamples3bpl.17:20|
 :skolemid |2|
 :no-pattern (type m@@2)
 :no-pattern (U_2_int m@@2)
 :no-pattern (U_2_bool m@@2)
 :no-pattern (U_2_int x@@8)
 :no-pattern (U_2_bool x@@8)
)) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (U_2_bool (MapType0Select h (int_2_U 42))))) (=> (not (U_2_bool (MapType0Select h (int_2_U 42)))) (=> (= (ControlFlow 0 2) (- 0 1)) false))))))
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 5) (let ((anon0_correct  (=> (forall ((m@@2 T@U) (x@@8 T@U) ) (! (let ((t (type x@@8)))
 (=> (= (type m@@2) (MapType0Type t boolType)) (= (U_2_bool (MapType0Select m@@2 x@@8)) false)))
 :qid |InterestingExamples3bpl.27:20|
 :skolemid |3|
 :no-pattern (type m@@2)
 :no-pattern (U_2_int m@@2)
 :no-pattern (U_2_bool m@@2)
 :no-pattern (U_2_int x@@8)
 :no-pattern (U_2_bool x@@8)
)) (and (=> (= (ControlFlow 0 2) (- 0 4)) (not (U_2_bool (MapType0Select h (int_2_U 42))))) (=> (not (U_2_bool (MapType0Select h (int_2_U 42)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (not (U_2_bool (MapType0Select (MapType0Store h (int_2_U 42) (bool_2_U true)) (int_2_U 42))))) (=> (not (U_2_bool (MapType0Select (MapType0Store h (int_2_U 42) (bool_2_U true)) (int_2_U 42)))) (=> (= (ControlFlow 0 2) (- 0 1)) false))))))))
