...
(= (type (MapType0Store arg0@@15 arg1@@3 arg2)) (MapType0Type aVar0 aVar1@@0))))
 ...
 :weight 0
)))) (= (type a) (MapType0Type intType intType))))
(assert (= (Length a) 3))
(assert (= (type b) (MapType0Type intType boolType)))
(assert (= (Length b) 5))
(push 1)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 6) (- 0 5)) true)))
(let ((anon2_Else_correct  (=> (and (not (and (<= 7 (Length a)) (<= (Length a) (Length b)))) (= (ControlFlow 0 7) 6)) GeneratedUnifiedExit_correct)))
(let ((anon2_Then_correct  (=> (and (and (<= 7 (Length a)) (<= (Length a) (Length b))) (and (= x@0 (U_2_bool (MapType0Select b (int_2_U 2)))) (= y@0 (U_2_int (MapType0Select a (int_2_U 1)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= x@0 (U_2_bool (MapType0Select b (int_2_U 2))))) (=> (= x@0 (U_2_bool (MapType0Select b (int_2_U 2)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= y@0 (U_2_int (MapType0Select a (int_2_U 1))))) (=> (= y@0 (U_2_int (MapType0Select a (int_2_U 1)))) (=> (= (ControlFlow 0 2) (- 0 1)) false))))))))
(let ((anon0_correct  (and (=> (= (ControlFlow 0 8) 2) anon2_Then_correct) (=> (= (ControlFlow 0 8) 7) anon2_Else_correct))))
...
(assert (not
 (=> (= (ControlFlow 0 0) 9) (let ((GeneratedUnifiedExit_correct  (=> (= (ControlFlow 0 6) (- 0 5)) true)))
(let ((anon2_Else_correct  (=> (and (not (and (<= 5 (Length a)) (<= (Length a) (Length b)))) (= (ControlFlow 0 7) 6)) GeneratedUnifiedExit_correct)))
(let ((anon2_Then_correct  (=> (and (and (<= 5 (Length a)) (<= (Length a) (Length b))) (and (= x@0 (U_2_bool (MapType0Select b (int_2_U 2)))) (= y@0 (U_2_int (MapType0Select a (int_2_U 1)))))) (and (=> (= (ControlFlow 0 2) (- 0 4)) (= x@0 (U_2_bool (MapType0Select b (int_2_U 2))))) (=> (= x@0 (U_2_bool (MapType0Select b (int_2_U 2)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (= y@0 (U_2_int (MapType0Select a (int_2_U 1))))) (=> (= y@0 (U_2_int (MapType0Select a (int_2_U 1)))) (=> (= (ControlFlow 0 2) (- 0 1)) false))))))))
(let ((anon0_correct  (and (=> (= (ControlFlow 0 8) 2) anon2_Then_correct) (=> (= (ControlFlow 0 8) 7) anon2_Else_correct))))
(let ((PreconditionGeneratedEntry_correct  (=> (= (ControlFlow 0 9) 8) anon0_correct)))
PreconditionGeneratedEntry_correct))))))
))
