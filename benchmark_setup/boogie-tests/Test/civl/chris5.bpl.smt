...
(declare-fun x@@0 () Int)
(set-info :boogie-vc-id Civl_Y_1)
...
(let ((anon0$1_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (= x@@0 0)) (=> (= x@@0 0) (and (=> (= (ControlFlow 0 6) 2) Civl_ReturnChecker_correct) (=> (= (ControlFlow 0 6) 5) Civl_NoninterferenceChecker$1_correct))))))
(let ((anon0_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (= x@@0 0)) (=> (= x@@0 0) (=> (= (ControlFlow 0 8) 6) anon0$1_correct)))))
