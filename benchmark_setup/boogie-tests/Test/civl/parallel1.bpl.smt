...
(push 1)
(declare-fun ControlFlow (Int Int) Int)
(declare-fun Civl_global_old_g@1 () Int)
(declare-fun g@3 () Int)
(declare-fun g@2 () Int)
(declare-fun g@1 () Int)
(declare-fun g@0 () Int)
...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 22) (let ((anon2_LoopBody_0_@2_anon2_LoopHead_correct true))
(let ((Civl_NoninterferenceChecker$1_correct true))
(let ((inline$Civl_NoninterferenceChecker_proc_PC_1$0$L0_correct  (=> (and (= Civl_global_old_g@1 3) (= (ControlFlow 0 12) (- 0 11))) (= g@3 3))))
(let ((anon2_LoopBody_0_@2_Civl_NoninterferenceChecker_correct  (=> (and (= g@3 g@2) (= Civl_global_old_g@1 g@2)) (and (=> (= (ControlFlow 0 18) 12) inline$Civl_NoninterferenceChecker_proc_PC_1$0$L0_correct) (=> (= (ControlFlow 0 18) 13) Civl_NoninterferenceChecker$1_correct)))))
(let ((anon2_LoopDone_@2_Civl_NoninterferenceChecker_correct  (=> (and (= g@3 g@1) (= Civl_global_old_g@1 g@1)) (and (=> (= (ControlFlow 0 16) 12) inline$Civl_NoninterferenceChecker_proc_PC_1$0$L0_correct) (=> (= (ControlFlow 0 16) 13) Civl_NoninterferenceChecker$1_correct)))))
(let ((anon2_LoopBody_@2_Civl_NoninterferenceChecker_correct  (=> (and (= g@3 g@1) (= Civl_global_old_g@1 g@1)) (and (=> (= (ControlFlow 0 15) 12) inline$Civl_NoninterferenceChecker_proc_PC_1$0$L0_correct) (=> (= (ControlFlow 0 15) 13) Civl_NoninterferenceChecker$1_correct)))))
(let ((anon0_@2_Civl_NoninterferenceChecker_correct  (=> (and (= g@3 g@0) (= Civl_global_old_g@1 g@0)) (and (=> (= (ControlFlow 0 14) 12) inline$Civl_NoninterferenceChecker_proc_PC_1$0$L0_correct) (=> (= (ControlFlow 0 14) 13) Civl_NoninterferenceChecker$1_correct)))))
...
(let ((anon2_LoopBody_0_correct  (=> (and (= g@2 3) (or false true)) (and (and (=> (= (ControlFlow 0 19) 17) anon2_LoopBody_0_@2_anon2_LoopHead_correct) (=> (= (ControlFlow 0 19) 18) anon2_LoopBody_0_@2_Civl_NoninterferenceChecker_correct)) (=> (= (ControlFlow 0 19) 5) Civl_UnchangedChecker_correct)))))
(let ((anon2_LoopHead_correct  (=> (or false true) (and (and (and (and (=> (= (ControlFlow 0 20) 19) anon2_LoopBody_0_correct) (=> (= (ControlFlow 0 20) 15) anon2_LoopBody_@2_Civl_NoninterferenceChecker_correct)) (=> (= (ControlFlow 0 20) 5) Civl_UnchangedChecker_correct)) (=> (= (ControlFlow 0 20) 8) Civl_ReturnChecker_correct)) (=> (= (ControlFlow 0 20) 16) anon2_LoopDone_@2_Civl_NoninterferenceChecker_correct)))))
(let ((Civl_RefinementChecker_correct  (and (=> (= (ControlFlow 0 2) (- 0 3)) true) (=> (= (ControlFlow 0 2) (- 0 1)) (=> false true)))))
(let ((anon0_correct  (and (and (=> (= (ControlFlow 0 21) 14) anon0_@2_Civl_NoninterferenceChecker_correct) (=> (= (ControlFlow 0 21) 2) Civl_RefinementChecker_correct)) (=> (= (ControlFlow 0 21) 20) anon2_LoopHead_correct))))
