...
(declare-fun x@1 () Int)
(declare-fun inline$ghost$0$z@1 () Int)
...
(let ((anon0$1_correct  (and (=> (= (ControlFlow 0 8) (- 0 9)) (= inline$ghost$0$z@1 2)) (=> (= inline$ghost$0$z@1 2) (=> (= (ControlFlow 0 8) 7) inline$AtomicIncr$0$anon0_correct)))))
(let ((inline$ghost$0$anon0_correct  (=> (and (= inline$ghost$0$z@1 (+ 1 1)) (= (ControlFlow 0 10) 8)) anon0$1_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 11) 10) inline$ghost$0$anon0_correct)))
...
(declare-fun Civl_ok@0 () Bool)
(declare-fun x@1 () Int)
(set-info :boogie-vc-id |Civl_Incr2'_1|)
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 11) (let ((Civl_NoninterferenceChecker$1_correct true))
(let ((Civl_ReturnChecker_correct  (and (=> (= (ControlFlow 0 2) (- 0 4)) (or false (or (= x@2 x@0) (= x@2 (+ x@0 2))))) (=> (or false (or (= x@2 x@0) (= x@2 (+ x@0 2)))) (and (=> (= (ControlFlow 0 2) (- 0 3)) (=> false (= x@2 x@0))) (=> (=> false (= x@2 x@0)) (=> (and (and (= Civl_pc@0  (=> (= x@2 x@0) false)) (= Civl_ok@0  (or (= x@2 (+ x@0 2)) false))) (= (ControlFlow 0 2) (- 0 1))) Civl_ok@0)))))))
(let ((anon0$4_correct  (and (=> (= (ControlFlow 0 6) (- 0 7)) (= x@2 (+ x@0 2))) (=> (= x@2 (+ x@0 2)) (and (=> (= (ControlFlow 0 6) 2) Civl_ReturnChecker_correct) (=> (= (ControlFlow 0 6) 5) Civl_NoninterferenceChecker$1_correct))))))
(let ((inline$AtomicIncr$1$anon0_correct  (=> (and (= x@2 (+ x@1 1)) (= (ControlFlow 0 8) 6)) anon0$4_correct)))
(let ((inline$AtomicIncr$0$anon0_correct  (=> (and (= x@1 (+ x@0 1)) (= (ControlFlow 0 9) 8)) inline$AtomicIncr$1$anon0_correct)))
(let ((anon0_correct  (=> (= (ControlFlow 0 10) 9) inline$AtomicIncr$0$anon0_correct)))
