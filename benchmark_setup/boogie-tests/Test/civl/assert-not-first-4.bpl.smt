...
(let ((anon0_correct  (=> (= (select arr i) 1) (and (=> (= (ControlFlow 0 7) (- 0 8)) (forall ((x@@0 Int) ) (! (= (select arr x@@0) 1)
 :qid |unknown.0:0|
 :skolemid |3|
))) (=> (forall ((x@@1 Int) ) (! (= (select arr x@@1) 1)
 :qid |unknown.0:0|
 :skolemid |3|
)) (=> (= (ControlFlow 0 7) 6) inline$FOO$0$anon0_correct))))))
(let ((PreconditionGeneratedEntry_correct  (=> (and (= (select arr i) 1) (= (ControlFlow 0 9) 7)) anon0_correct)))
