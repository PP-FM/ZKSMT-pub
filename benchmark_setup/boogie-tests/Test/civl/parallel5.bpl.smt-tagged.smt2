...
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 28) (let ((Civl_ReturnChecker_correct  (and (=> (= (ControlFlow 0 18) (- 0 20)) true) (and (=> (= (ControlFlow 0 18) (- 0 19)) (=> Civl_pc@3 true)) (=> (=> Civl_pc@3 true) (=> (and (and (= Civl_pc@5  (=> true Civl_pc@3)) (= Civl_ok@4  (or true Civl_ok@3))) (= (ControlFlow 0 18) (- 0 17))) Civl_ok@4))))))
...
(let ((anon0_1_correct  (=> (and (= Civl_pc@2  (=> true Civl_pc@1)) (= Civl_ok@2  (or true Civl_ok@1))) (and (=> (= (ControlFlow 0 23) (- 0 24)) (= (select a@2 call1formal@Civl_0_tid@0) (select a@2 call1formal@Civl_0_tid@0))) (=> (= (select a@2 call1formal@Civl_0_tid@0) (select a@2 call1formal@Civl_0_tid@0)) (=> (and (and (= (select a@2 call1formal@Civl_0_tid@0) (select a@3 call1formal@Civl_0_tid@0)) (or Civl_pc@2 true)) (and (= Civl_linear_tid_available@3 ((_ map or) (store ((as const (Array Int Bool)) false) call1formal@Civl_0_tid@0 true) ((_ map or) (store ((as const (Array Int Bool)) false) call4formal@Civl_0_i@0 true) ((as const (Array Int Bool)) false)))) (exists ((Civl_partition_tid@@0 (Array Int Int)) ) (!  (and (= ((_ map =>) (store ((as const (Array Int Bool)) false) call4formal@Civl_0_i@0 true) ((_ map (= (Int Int) Bool)) Civl_partition_tid@@0 ((as const (Array Int Int)) 0))) ((as const (Array Int Bool)) true)) (= ((_ map =>) (store ((as const (Array Int Bool)) false) call1formal@Civl_0_tid@0 true) ((_ map (= (Int Int) Bool)) Civl_partition_tid@@0 ((as const (Array Int Int)) 1))) ((as const (Array Int Bool)) true)))
 :qid |unknown.0:0|
 :skolemid |6|
...
(let ((anon0_2_correct  (=> (and (and (and (= Civl_pc@1  (=> true Civl_pc@0)) (= Civl_ok@1  (or true Civl_ok@0))) (or Civl_pc@1 true)) (and (= Civl_linear_tid_available@2 ((_ map or) (store ((as const (Array Int Bool)) false) call1formal@Civl_0_tid@0 true) ((_ map or) (store ((as const (Array Int Bool)) false) call1formal@Civl_0_tid@0@@0 true) ((as const (Array Int Bool)) false)))) (exists ((Civl_partition_tid@@1 (Array Int Int)) ) (!  (and (= ((_ map =>) (store ((as const (Array Int Bool)) false) call1formal@Civl_0_tid@0@@0 true) ((_ map (= (Int Int) Bool)) Civl_partition_tid@@1 ((as const (Array Int Int)) 0))) ((as const (Array Int Bool)) true)) (= ((_ map =>) (store ((as const (Array Int Bool)) false) call1formal@Civl_0_tid@0 true) ((_ map (= (Int Int) Bool)) Civl_partition_tid@@1 ((as const (Array Int Int)) 1))) ((as const (Array Int Bool)) true)))
 :qid |unknown.0:0|
 :skolemid |5|
)))) (and (and (=> (= (ControlFlow 0 25) 23) anon0_1_correct) (=> (= (ControlFlow 0 25) 13) anon0_2_@2_Civl_NoninterferenceChecker_correct)) (=> (= (ControlFlow 0 25) 14) anon0_2_@2_Civl_RefinementChecker_correct)))))
(let ((anon0_3_@2_Civl_RefinementChecker_correct  (=> (and (= Civl_pc@4 Civl_pc@0) (= (ControlFlow 0 12) 2)) Civl_RefinementChecker_correct)))
(let ((anon0_3_correct  (=> (and (and (= Civl_pc@0  (=> true false)) (= Civl_ok@0  (or true false))) (and (or Civl_pc@0 true) (= Civl_linear_tid_available@1 ((_ map or) (store ((as const (Array Int Bool)) false) call1formal@Civl_0_tid@0@@0 true) ((as const (Array Int Bool)) false))))) (and (and (=> (= (ControlFlow 0 26) 25) anon0_2_correct) (=> (= (ControlFlow 0 26) 11) anon0_3_@2_Civl_NoninterferenceChecker_correct)) (=> (= (ControlFlow 0 26) 12) anon0_3_@2_Civl_RefinementChecker_correct)))))
(let ((anon0_@2_Civl_RefinementChecker_correct  (=> (and (= Civl_pc@4 false) (= (ControlFlow 0 4) 2)) Civl_RefinementChecker_correct)))
(let ((anon0_correct  (=> (= Civl_linear_tid_available@0 ((as const (Array Int Bool)) false)) (and (and (=> (= (ControlFlow 0 27) 26) anon0_3_correct) (=> (= (ControlFlow 0 27) 10) anon0_@2_Civl_NoninterferenceChecker_correct)) (=> (= (ControlFlow 0 27) 4) anon0_@2_Civl_RefinementChecker_correct)))))
