...
// Types
#define Type int32_t
const Type TY_DEFAULT = 0;
const Type TY_BOOL = 1;
const Type TY_INT = 2;

// The 2nd highest bit in a type indicates it is a defined sort. The other bits
// decide the sort index.
const int32_t TY_DEF_SORT_BIT = (1 << 30);
// The highest bit in a type being set indicates that this is not a type, it is
// used in an expr list table entry to indicate this expr list is an application
// list for a specific uninterpreted function (UF). DEF_SORT_BIT should be 0.
// The rest of the bits indicate the index of the particular UF this is an
// application of.
...
public:
    ...
    vector<Type> expr_list_type_table;
    vector<int32_t> expr_list_max_height_table;
    vector<UfEntry> uf_table;
